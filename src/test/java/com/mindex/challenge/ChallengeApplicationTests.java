...
public class ChallengeApplicationTests {
	...
	public void EmployeeTests() {
				...
				Employee rec = this.empController.read("16a596ae-edd3-4847-99fe-c4518e82c86f");
				
				assertNotNull(rec);
				assertEquals("John", rec.getFirstName());
				assertEquals("Lennon", rec.getLastName());
				assertEquals("Development Manager", rec.getPosition());
				assertEquals("Engineering", rec.getDepartment());
					}
